...
#from mobileNet import get_content_features
#mobilenet2 = get_content_features() 
...
py.arg('--datasets_dir', default='E:/thesis/Implimentation/dataset/datasets/flowers/')#/media/cvr/HardDisk2/thesis/Implimentation
...
base_model = efn.EfficientNetB7(input_shape=(256, 256, 3),include_top=False)
x = base_model.layers[-4].output
'''
base_model = tf.keras.models.load_model('saved_model/my_model_mobilenet')
