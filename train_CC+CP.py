...
# =                                   param                                    =
# ==============================================================================
#E:/thesis/Implimentation/dataset/datasets/flowers/01
#/media/cvr/HardDisk2/thesis/Implimentation/dataset/datasets
py.arg('--dataset', default='Day_to_Sunset')
py.arg('--datasets_dir', default='E:/thesis/Implimentation/dataset/datasets/Viper/')
#py.arg('--dataset', default='01')
#py.arg('--datasets_dir', default='#E:/thesis/Implimentation/dataset/datasets/flowers/')
...
# =                                 train step                                 =
# ==============================================================================
#Frame = 255 * np.ones((2,256,256,3), tf.float32)
#print('Frame :',Frame)

Frame = tf.Variable(initial_value=(255 * np.ones((args.batch_size,256,256,3), np.float32)), trainable=False, dtype=tf.float32)
...
def train_G(A, B):
    with tf.GradientTape() as t:
        ...
        G_loss = (M_A_A2B + M_B_B2A) * args.identity_loss_weight + (A2B_g_loss + B2A_g_loss) + (A2B2A_cycle_loss + B2A2B_cycle_loss) * args.cycle_loss_weight + (A2A_id_loss + B2B_id_loss) * args.identity_loss_weight
